...
public class PlayerShield : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown(shieldKey))
        {
            ...
            // --- NUEVO: Sonido de Escudo en bucle ---
            if (SoundManager.instance != null)
                SoundManager.instance.PlayLoop(SoundManager.instance.shieldLoopClip);
        }
